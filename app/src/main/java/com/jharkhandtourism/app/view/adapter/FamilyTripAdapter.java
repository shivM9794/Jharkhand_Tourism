...
public class FamilyTripAdapter extends RecyclerView.Adapter<FamilyTripAdapter.ViewHolder> {

    Context context;

    ArrayList<DestinationsModel> destinations = new ArrayList<>();

    public FamilyTripAdapter(Context context, ArrayList<DestinationsModel> destinations) {
