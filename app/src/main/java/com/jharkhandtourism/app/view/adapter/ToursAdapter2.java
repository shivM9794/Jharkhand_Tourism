...
public class ToursAdapter2 extends RecyclerView.Adapter<ToursAdapter2.ViewHolder> {
    ...
    public ToursAdapter2(Context context, ArrayList<TourModel> tours) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.tour_list_item2, parent, false);
